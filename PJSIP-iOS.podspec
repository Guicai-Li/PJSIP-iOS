Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Guicai-Li/PJSIP-iOS.git", :tag => "#{s.version}" }
  s.platform     = :ios, '7.0'
  s.description  = <<-DESC
...
LICENSE
  ...
  s.vendored_libraries  = 'PJSIP/libs/pjlib-util/*.a',
                          'PJSIP/libs/pjlib/*.a',
                          'PJSIP/libs/pjmedia/*.a',
                          'PJSIP/libs/pjnath/*.a',
                          'PJSIP/libs/pjsip/*.a',
                          'PJSIP/libs/third_party/*.a'

  header_search_paths   = '"$(PODS_ROOT)/PJSIP/includes/pjsip/include"',
                          '"$(PODS_ROOT)/PJSIP/includes/pjlib/include"',
                          '"$(PODS_ROOT)/PJSIP/includes/pjlib-util/include"',
                          '"$(PODS_ROOT)/PJSIP/includes/pjnath/include"',
                          '"$(PODS_ROOT)/PJSIP/includes/pjmedia/include"'
